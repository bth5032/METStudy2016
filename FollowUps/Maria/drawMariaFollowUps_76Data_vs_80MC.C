...
TString drawAll(vector<TString> plot_names, TString input_dir, TString save_dir, bool do_extra=true){
  ...
  //76Data vs 80 MC
  TFile* f_data = new TFile(input_dir+"76Data/METStudy_data.root");

  TFile* f_DY = new TFile(input_dir+"80MC/METStudy_DY.root");
  TFile* f_TTbar = new TFile(input_dir+"80MC/METStudy_TTBar.root");;
  ...
  if (do_extra) {
    f_ST = new TFile(input_dir+"80MC/METStudy_SingleTop.root");
    f_VVV = new TFile(input_dir+"80MC/METStudy_VVV.root");
    f_WW = new TFile(input_dir+"80MC/METStudy_WW.root");
    f_WZ = new TFile(input_dir+"80MC/METStudy_WZ.root");
    f_ZZ = new TFile(input_dir+"80MC/METStudy_ZZ.root");
  }
...
void drawMariaFollowUps_80Data_vs_76MC(TString save_dir="~/public_html/ZMET2016/looper/maria/76DataVs80MC/", TString input_dir="~/maria/", bool pt=true, bool phi=false, bool sumET=true, bool MET=false, bool extra=true, bool do_extra=true)
{
