...
void drawMariaFollowUps_76Data_vs_80MC(TString save_dir="~/public_html/ZMET2016/looper/maria/76DataVs80MC/", TString input_dir="~/maria/", bool pt=true, bool phi=false, bool sumET=true, bool MET=false, bool extra=true, bool do_extra=true)
{
