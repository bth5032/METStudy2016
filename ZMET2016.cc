	...
	// load all branches
{
	...
	const float &ZMET2016::met_caloPt()
	{
	...
	const float &ZMET2016::met_caloPhi()
	{
...
namespace zmet {
	...
	const float &met_caloPt() { return phys.met_caloPt(); }
	const float &met_caloPhi() { return phys.met_caloPhi(); }
