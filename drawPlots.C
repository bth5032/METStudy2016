...
void drawPlots(bool pt=true, bool phi=true, bool extra=true, TString save_dir = "~/public_html/ZMET2016/looper/noDup/", TString input_dir = "/nfs-7/userdata/bobak/METStudy2016/76Histos/")
{
